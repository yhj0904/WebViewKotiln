...
object AppConstants {
    ...
    const val PUSH_SAVE_TOKEN_URL = "http://192.168.10.205:8086/api/token/register"
    const val PUSH_REMOVE_TOKEN_URL = "http://192.168.10.205:8086/api/token/delete"
    ...
    const val APP_URL = "https://mis.kunsan.ac.kr/"
